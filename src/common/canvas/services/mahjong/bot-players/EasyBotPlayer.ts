...
import {getShantenInfo} from "../../../utils/hand/getShantenInfo";
import {hasTiles, isTheSameTile} from "../../../utils/tiles/tileContains";

export class EasyBotPlayer implements IBotPlayer {
    private shantenInfo: HandStructureVariant[] = []
