...
describe('getBaseShantenCount', () => {
    describe('13 tiles', () => {
        ...
        it('should be 2 shanten when hand has 2 melds and 2 sequence groups', () => {
            expect(getBaseShantenCount(13, 2, 2, false)).toBe(2)
        })

        it('should be 2 shanten when hand has 2 melds and 2 groups including pair', () => {
            expect(getBaseShantenCount(13, 2, 2, true)).toBe(2)
        })

        it('should be 3 shanten when hand has 1 melds and 4 sequence groups', () => {
            expect(getBaseShantenCount(13, 1, 4, false)).toBe(3)
        })

        it('should be 3 shanten when hand has 1 melds and 4 groups including pair', () => {
            expect(getBaseShantenCount(13, 1, 4, true)).toBe(3)
        })
